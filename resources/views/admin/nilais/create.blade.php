...
<div class="card">
    <div class="card-header">
        <div class="card-header-title">
            <span class="material-symbols-outlined fill">post_add</span>
            Input Nilai Baru
        </div>
    </div>
    <div class="card-body">
        <div class="alert alert-security mb-4">
            ...
            <div>
                <div style="font-size:12px;font-weight:600;margin-bottom:2px;">Enkripsi AES-256-GCM Aktif</div>
                <div style="font-size:11px;">Data nilai angka akan disimpan ke database secara otomatis dalam format terenkripsi (JSON Ciphertext).</div>
            </div>
        </div>
        ...
        <form action="{{ route('admin.nilais.store') }}" method="POST">
            ...
            <div class="grid grid-2 gap-3 mb-4">
                <div class="form-group mb-0">
                    ...
                    <input type="number" step="0.01" name="nilai_angka" id="nilai_angka" class="form-control @error('nilai_angka') is-invalid @enderror" value="{{ old('nilai_angka') }}" min="0" max="100" required>
                ...
                <div class="form-group mb-0">
                    ...
                    <input type="text" name="semester_tahun" id="semester_tahun" class="form-control @error('semester_tahun') is-invalid @enderror" value="{{ old('semester_tahun', date('Y').'/'.(date('Y')+1).' Ganjil') }}" placeholder="Contoh: 2024/2025 Ganjil" required>
